 ...
 * api 接口
 */
// const webApi = 'http://demobrc.wincome.group'   //微信相关
// const SApi = 'http://demobrc.wincome.group/WeChatAPI_New'//外网
...
const userApi = {
	...
	GetOpenid: webApi + '/patientOrderingNew.API/api/Patient/GetOpenid',   //获取GetOpenid
	GetSignature: webApi + '/patientOrderingNew.API/api/Patient/GetSignature',  //获取微信JSSDK签名
	...
	GetPrepayid: webApi + '/patientOrderingNew.API/api/Patient/GetPrepayid',   //预支付

    ...
    computed: {
      newSelectFoods() {
        ...
        for (let orderingMode in orderingModeGroup) {
          ...
          console.log({
            'this.SingleSelectFoods': this.SingleSelectFoods
          })
    ...
    .progress {
      ...
      .ball {
        ...
        .counter {
          ...
          &.counter2 {
            color: #6fc8a2;
            background: url(../assets/meal/progress2@2x.png) center center no-repeat;
            background-size: 100% 100%;
          }

          &.counter3 {
            color: #ff8361;
            background: url(../assets/meal/progress3@2x.png) center center no-repeat;
            background-size: 100% 100%;
          }

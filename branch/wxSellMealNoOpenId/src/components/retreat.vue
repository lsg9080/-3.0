<template>
  <div class="retreat">
    <div class="retreatList">
      ...
      <checkbox-all ref="checkboxAllChild" v-for="(item, index) in getOrderDetail.repastList" :key="index" :retreatList="item"
        @selectPriceData="selectPriceData"></checkbox-all>
    </div>
    ...
    .retreatList {
      ...
      .checkboxGroup {
        ...
        input[type='checkbox']:before {
          ...
          width: 20px;
          height: 20px;
          background: url(../assets/account/sel@2x.png) no-repeat center center;
        ...
        input[type='checkbox']:checked:before {
          ...
          width: 20px;
          height: 20px;
          background: url(../assets/account/sel-on@2x.png) no-repeat center center;
          background-size: 100% 100%;
          box-sizing: border-box;
          position: absolute;
          transform: scale(1);

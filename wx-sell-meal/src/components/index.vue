    ...
    if (getopenid == null || getopenid == undefined || getopenid == "") {
      ...
      if (opencode == null || opencode == undefined || opencode == "") {
        window.location.href =
          `https://open.weixin.qq.com/connect/oauth2/authorize?appid=${wechatAppId}&redirect_uri=${homePage}&response_type=code&scope=snsapi_base&state=123#wechat_redirect`;
      } else {
        console.log("2");
        var _this = this;

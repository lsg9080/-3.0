    ...
    <div class="rechargeCon">
      <div class="wrapper">
        ...
        <div class="amountInput">
          <i></i>
          <input disabled="disabled" v-model.number="amount" type="tel" maxlength="4" class="input" placeholder="不少于10元" />
        </div>
        ...
        <div v-show="rechargeAble" class="rechargeBtn" @click="rechargeBtn">充值</div>
        <div v-show="!rechargeAble" class="rechargeBtn">充值</div>
      </div>
    </div>
  ...
  export default {
    ...
    methods: {
      getParams() {
        ...
        var amo = parseFloat(balance).toFixed(2)
        if (amo==0) {
          this.amount = 0

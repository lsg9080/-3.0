    ...
    <transition name="payWay-fade">
      <div class="paymentMethod" v-show="$store.state.payWayShow">
            ...
            <li v-for="(item, index) in rePaymentList" :key="index">
              <label :for="'way' + index">
                <div v-if="item.name === '膳食账户'" class="wayImg">
                  <img v-if="item.balance < payPrice" src="../assets/account/account2@2x.png" />
                  <img v-else src="../assets/account/account1@2x.png" />
                  {{ item.name
                  }}
                  <span
                    :class="classObject"
                  >（余额 ¥{{ item.balance }}）</span>
                </div>
                ...
                <div v-else class="waySel">
                  ...
                  <input
                    ...
                    @click="checkPayWay(index, item.code)"
                    type="radio"
                  />
                </div>
              </label>
        ...
        <div class="bottom">
          <div class="L">
            需支付：
            <span class="price">¥ {{ payPrice.toFixed(1) }}</span>
          </div>
        ...
        .then(res => {
          if (res.data.code == "0") {
            ...
            if (_this.radio == "001") {
              ...
              //   url:'/pages/mealsSubmit/mealsSubmit?price='+payPrice+'&merchantTradeId='+opthions.payId+'&type='+ _this.$route.query.id+'&ordercode='+window.orderCode+'&payid='+window.payId,
              // });
    ...
    ul li {
      ...
      .waySel {
        ...
        .radio {
          ...
          background: url(../assets/account/radio@2x.png) center center
            no-repeat;

    ...
    return new Promise((resolve, reject) => {
        axios.get('../static/serverConfig.json').then((result) => {
            ...
            const userApi = {
                ...
                GetSubmitOrderRemindMsg: PApi + '/api/PatientMeal/GetSubmitOrderRemindMsg', //去下单前的提示信息

            }

            Vue.prototype.api = userApi
            Vue.prototype.$wechatAppId = config.appid
            Vue.prototype.$homePage = config.homePage

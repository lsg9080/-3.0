 ...
 * api 接口
 */
/*const webApi = 'http://yydc.qiluhospital.com/patientOrdering.api'   //微信相关
const SApi = 'http://yydc.qiluhospital.com/WeChatAPI'//外网
const PApi = 'http://yydc.qiluhospital.com/PatientNew'*/

import {PApi,SApi,webApi} from '@/common/env'

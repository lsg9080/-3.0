<template>
  <div class="login">
    <div class="loginTop">
      为了能为患者准确供餐，<br />需要绑定与校验患者的身份信息
    </div>
    <div class="loginForm">
      <ul>
        <li>
          <div class="tit">住院号</div>
          <input :disabled="inputDisabled" :class="{ pointEventNone: inputDisabled }" class="input" v-model.trim="loginModel.hosNumber"
            placeholder="请输入住院号" />
        </li>
        <li>
          <div class="tit">姓名</div>
          <!-- weixin -->
          <input :disabled="inputDisabled" :class="{ pointEventNone: inputDisabled }" class="input" v-model.trim="loginModel.username"
            placeholder="请输入姓名" />
        </li>
        <li class="cbInput">
          <div class="tit">手机号</div>
          <div class="rel">
            <input class="input" type="tel" v-model.trim="loginModel.phone" placeholder="请输入手机号" @focus="focusShow" />
          ...
          <div class="rel">
            ...
            <button :disabled="disabled" class="codeFn" @click="codeFn">
              {{ codeText }}
            </button>
          </div>
        </li>
    ...
    <div class="dialog-tips-special" v-show="visible">
      <div class="header"><i class="iconjinggao"></i>住院信息未查到</div>
      <div class="content">
        <p>可能原因：</p>

          ...
          <div class="menu-wrapper" ref="menuWrapper">
            <ul>
              <li
                ...
                @click="selectMenu(innerIndex,$event)"
                ref="menuList"
              >
                ...
                <ul class="foodsWrapper">
                  <li class="food-item" v-for="food in item.menuList" :key="food.code">
                    ...
                    <div class="foodNutrient" @click="selectFood(food, $event)">
                      <span>能量:{{food.Nutrients.能量}}kcal</span>
                      <span>蛋白质:{{food.Nutrients.蛋白质}}g</span>
                      <span class="more">
                        了解更多
                        <i class="iconright"></i>
                      </span>
                  ...
                  >
                    ...
                    <div class="foodNutrientWrapper">
                      <div class="foodNutrient">
                        <div class="L">
                          <span>能量：{{item.Nutrients.能量}}kcal</span>
                          <span>蛋白质：{{item.Nutrients.蛋白质}}g</span>
                        </div>
                  ...
                  <ul class="setMeal NSelectM">
                    ...
                    >
                      ...
                      <div class="foodNutrientWrapper">
                        <div class="foodNutrient">
                          <div class="L">
                            <span>能量：{{mealItem.Nutrients.能量}}kcal</span>
                            <span>蛋白质：{{mealItem.Nutrients.蛋白质}}g</span>
                          </div>
                          <div class="more">
                            了解更多
                            <i class="iconright"></i>
          ...
          if (res.data.code == "0") {
            ...
            if (!result) {
              ...
              if (res.data.data.orderingMode === 1) {
                for (
                  let i = 0;
                  i < tempMenu.dataList[0].repastDataList.length;
                  i++
                ) {
                  for (
                    let j = 0;
                    j < tempMenu.dataList[0].repastDataList[i].menuList.length;
                    j++
                  ) {
                    tempMenu.dataList[0].repastDataList[i].menuList[
                      j
                    ].moduleId = _this.currentModuleId;
                    tempMenu.dataList[0].repastDataList[i].menuList[
                      j
                    ...
                    tempMenu.dataList[0].repastDataList[i].menuList[
                      j
                    ].moduleName = _this.currentModuleName;
                    tempMenu.dataList[0].repastDataList[i].menuList[
                      j
                    ].repastName = _this.currentRepastName;
                    tempMenu.dataList[0].repastDataList[i].menuList[
                      j
                    ].orderingMode = res.data.data.orderingMode;
                    tempMenu.dataList[0].repastDataList[i].menuList[
                      j
                    ].menuTypeName =
                      tempMenu.dataList[0].repastDataList[i].menuTypeName;
                    tempMenu.dataList[0].repastDataList[i].menuList[
                      j
                    ].count = 0;
                    //提交订单使用
                    tempMenu.dataList[0].repastDataList[i].menuList[
                      j
                    ].mealDate = res.data.data.mealDate;
                    tempMenu.dataList[0].repastDataList[i].menuList[
                      j
                    ].cateringTypeId = res.data.data.cateringTypeId;
                    tempMenu.dataList[0].repastDataList[i].menuList[
                      j
                    ].cateringId = res.data.data.cateringId;
                    tempMenu.dataList[0].repastDataList[i].menuList[
                      j
                    ].cateringTime = res.data.data.cateringTime;
                    tempMenu.dataList[0].repastDataList[i].menuList[
                      j
                    ].dietAdviceId = res.data.data.dietAdviceId;
                    ...
                    var foodIndex = myCurrentCarFoods.findIndex(
                      n =>
                        n.code ==
                        tempMenu.dataList[0].repastDataList[i].menuList[j].code
                    );
                    if (foodIndex != -1)
                      tempMenu.dataList[0].repastDataList[i].menuList[j].count =
